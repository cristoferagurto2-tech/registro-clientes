    ...
    <div className="welcome-illustration">
      ...
      >
        ...
        <g transform="translate(180, 60)">
          <path d="M35 180 L35 220 L45 220 L50 180 L65 180 L70 220 L80 220 L75 180 Z" fill="#1e3a8a" />
          <ellipse cx="40" cy="222" rx="12" ry="6" fill="#1f2937" />
          <ellipse cx="75" cy="222" rx="12" ry="6" fill="#1f2937" />
          
          <path d="M25 80 Q20 130, 25 180 L90 180 Q95 130, 90 80 Q90 70, 80 65 L35 65 Q25 70, 25 80" fill="#1e40af" />
          <path d="M25 80 L40 130 L57 115 L35 65" fill="#1e3a8a" />
          <path d="M90 80 L75 130 L58 115 L80 65" fill="#1e3a8a" />
          <path d="M40 65 L57 90 L74 65 L57 60 Z" fill="white" />
          <rect x="52" y="55" width="10" height="12" fill="#fdba74" />
          <ellipse cx="57" cy="40" rx="22" ry="26" fill="#fdba74" />
          <path d="M35 25 Q30 40, 35 55 L40 50 Q35 35, 40 20 Q57 15, 74 20 Q79 35, 74 50 L79 55 Q84 40, 79 25 Q79 5, 57 5 Q35 5, 35 25" fill="#1f2937" />
          <path d="M35 20 Q45 12, 57 15 Q69 12, 79 20 Q70 8, 57 8 Q44 8, 35 20" fill="#1f2937" />
          ...
          <path d="M25 85 Q15 110, 20 135" stroke="#1e3a8a" strokeWidth="12" fill="none" strokeLinecap="round" />
          <path d="M90 85 Q100 110, 75 120" stroke="#1e3a8a" strokeWidth="12" fill="none" strokeLinecap="round" />
